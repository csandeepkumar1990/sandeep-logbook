"use strict";var svgdom;module.watch(require('../dom'),{default(v){svgdom=v}},0);var assert;module.watch(require('assert'),{default(v){assert=v}},1);/* global describe, it */
